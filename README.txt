...
The user specifies a start point and goal point in the maze and the program finds the optimal path to the goal. The program generates a visualization of the searched nodes in yellow and plots the path to the goal in red. The code has two main modes point robot and rigid robot.
